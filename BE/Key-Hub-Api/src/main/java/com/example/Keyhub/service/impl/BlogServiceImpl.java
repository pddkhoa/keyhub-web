...
public class BlogServiceImpl implements IBLogService {
    ...
    public List<BlogDTO> getBlogBySearch(String key, Users users) {
        ...
        logger.error("Unsupported JWT toekn ->Message: {}",list.size());
        return blogDTOs;
    }
    ...
    public List<BlogDTO> getFiveBlogPopular(Users users) {
        ...
        {
            logger.error("Bị rỗng");
            logger.info("Ngày bắt đầu: " + df.format(startDate));
            logger.info("Ngày kết thúc: " + df.format(endDate));
