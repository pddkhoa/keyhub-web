...
-- ----------------------------
INSERT INTO `blog_comment` VALUES (53, 205, 59);
INSERT INTO `blog_comment` VALUES (55, 207, 61);
INSERT INTO `blog_comment` VALUES (56, 208, 62);
INSERT INTO `blog_comment` VALUES (59, 203, 65);
INSERT INTO `blog_comment` VALUES (60, 204, 66);
INSERT INTO `blog_comment` VALUES (62, 201, 68);
INSERT INTO `blog_comment` VALUES (63, 201, 69);
INSERT INTO `blog_comment` VALUES (64, 201, 70);
INSERT INTO `blog_comment` VALUES (65, 201, 71);
INSERT INTO `blog_comment` VALUES (66, 201, 72);
INSERT INTO `blog_comment` VALUES (67, 201, 73);
...
INSERT INTO `blog_like` VALUES (56, 202, 69);
INSERT INTO `blog_like` VALUES (57, 210, 69);
...
INSERT INTO `blog_save` VALUES (19, 210, 69);
...
INSERT INTO `blog_tag` VALUES (245, 18);
INSERT INTO `blog_tag` VALUES (245, 21);
...
INSERT INTO `chat` VALUES (17, NULL, NULL, b'0', 69, '2023-12-13 20:31:21.820000');
INSERT INTO `chat` VALUES (18, NULL, NULL, b'0', 69, '2023-12-14 07:13:43.070000');
...
INSERT INTO `chat_users` VALUES (17, 35);
...
INSERT INTO `chat_users` VALUES (17, 69);
INSERT INTO `chat_users` VALUES (18, 69);
INSERT INTO `chat_users` VALUES (15, 96);
INSERT INTO `chat_users` VALUES (16, 96);
INSERT INTO `chat_users` VALUES (18, 96);
...
-- Records of comment
-- ----------------------------
INSERT INTO `comment` VALUES (59, 'Bài viết tốt', NULL, 96, '2023-12-16 21:02:57');
INSERT INTO `comment` VALUES (61, 'Bài viết tuyệt đỉnh', NULL, 96, '2023-12-16 21:03:28');
INSERT INTO `comment` VALUES (62, 'Tôi thấy ổn', NULL, 96, '2023-12-16 21:03:29');
INSERT INTO `comment` VALUES (64, 'Bài viết hay', NULL, 96, '2023-12-16 21:07:23');
INSERT INTO `comment` VALUES (65, 'Bài viết hay', NULL, 96, '2023-12-16 21:07:24');
INSERT INTO `comment` VALUES (66, 'Bài viết hay', NULL, 96, '2023-12-16 21:07:25');
INSERT INTO `comment` VALUES (68, 'Bài viết hay', NULL, 96, '2023-12-17 09:50:02');
INSERT INTO `comment` VALUES (69, 'Bài viết hay', NULL, 96, '2023-12-17 09:51:23');
INSERT INTO `comment` VALUES (70, 'Bài viết hay', NULL, 96, '2023-12-17 10:07:58');
INSERT INTO `comment` VALUES (71, 'Bài viết hay', NULL, 96, '2023-12-17 10:10:31');
INSERT INTO `comment` VALUES (72, 'Bài viết hay', NULL, 96, '2023-12-17 10:11:52');
INSERT INTO `comment` VALUES (73, 'Bài viết hay', NULL, 96, '2023-12-17 10:18:09');
...
) ENGINE = InnoDB AUTO_INCREMENT = 2519 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = DYNAMIC;
...
INSERT INTO `follow` VALUES (2518, 42, 69);
...
INSERT INTO `message` VALUES (13, 'Chào bạn', '2023-12-13 20:31:21.819000', 17, 69);
...
CREATE TABLE `notification`  (
  ...
  `target_blog_blog_id` bigint NULL DEFAULT NULL,
  `is_read` bit(1) NULL DEFAULT NULL,
  `notification_type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `create_date` datetime(6) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `FKqnduwq6ix2pxx1add03905i1i`(`recipient_id` ASC) USING BTREE,
  INDEX `FKnbt1hengkgjqru2q44q8rlc2c`(`sender_id` ASC) USING BTREE,
  INDEX `FKcdgp44llutntjde9b5jcch56u`(`target_blog_blog_id` ASC) USING BTREE,
  CONSTRAINT `FKcdgp44llutntjde9b5jcch56u` FOREIGN KEY (`target_blog_blog_id`) REFERENCES `blog` (`blog_id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `FKnbt1hengkgjqru2q44q8rlc2c` FOREIGN KEY (`sender_id`) REFERENCES `user` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `FKqnduwq6ix2pxx1add03905i1i` FOREIGN KEY (`recipient_id`) REFERENCES `user` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
-- ----------------------------
INSERT INTO `refreshtoken` VALUES (15, '2023-12-18 10:25:54.809000', '607dfa81-6188-43a7-b482-47f239e2dccc', 96);
...
INSERT INTO `report` VALUES (41, 69, 202, 'Ngôn từ gây thù ghét, Thông tin sai sự thật', '2023-12-14 07:14:59.582000');
...
CREATE TABLE `report_comment`  (
  ...
  `user_id` bigint NULL DEFAULT NULL,
  PRIMARY KEY (`Id`) USING BTREE,
  INDEX `FKis0gtk48kla9g7m7nmj31noh5`(`user_id` ASC) USING BTREE,
  INDEX `FK492nbeaxxddyi0tag6s48fwru`(`comment_id` ASC) USING BTREE,
  CONSTRAINT `FK492nbeaxxddyi0tag6s48fwru` FOREIGN KEY (`comment_id`) REFERENCES `comment` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `FKis0gtk48kla9g7m7nmj31noh5` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 23 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of report_comment
-- ----------------------------
INSERT INTO `report_comment` VALUES (28, '2023-12-16 21:05:13.010000', 'Chính trị xã hội', 59, 96);
INSERT INTO `report_comment` VALUES (31, '2023-12-16 21:07:12.829000', 'Chính trị xã hội', 61, 96);
INSERT INTO `report_comment` VALUES (32, '2023-12-16 21:07:54.526000', 'Chính trị xã hội', 64, 96);
INSERT INTO `report_comment` VALUES (33, '2023-12-16 21:07:57.971000', 'Chính trị xã hội', 65, 96);
...
INSERT INTO `series` VALUES (76, 'Phim ', 69, '2023-11-16 23:06:57.741000', '', 1);
...
INSERT INTO `tag` VALUES (17, 'PhiêuLưuKý', 1);
...
INSERT INTO `user` VALUES (67, 'Hồ Huyền Oanh', 'ngochai06122002@gmail.com', '$2a$10$nAMirCZSM.D0C7edv9.E4eZf.ynn.k1NQGdXGXylWg4cFkdmWvysK', 'UserHaiTest', '0814069391', '2023-10-16 18:17:28.197000', '2023-12-15 13:11:07', 'https://images.pexels.com/photos/775358/pexels-photo-775358.jpeg?auto=compress&cs=tinysrgb&w=600', 'Nam', 'Tiny', 1, 'Tình yêu thể thao không chỉ giúp tôi duy trì sức khỏe mà còn tạo ra cộng đồng đoàn kết và niềm vui.', 'UTE', 'Bà Rịa Vũng Tàu', '3FORCOM', 'Bà Rịa Vũng Tàu', 'https://images.pexels.com/photos/163872/italy-cala-gonone-air-sky-163872.jpeg?auto=compress&cs=tinysrgb&w=600', 0, 1, 21, 24, 'ADMIN');
...
INSERT INTO `user` VALUES (96, 'Lê Trương Ngọc Hải', '20110465@student.hcmute.edu.vn', '$2a$10$mspJrmIy07H6tu5vIfwJUu/SfACsbVCGR8UGlq68U4KYYYWjF.h3q', 'UserNgocHai', '0814069391', '2023-11-15 11:32:35.663000', '2023-12-13 20:13:04', 'http://res.cloudinary.com/dmpru0wgq/image/upload/v1702473079/whxvakc6pywfzykkvbxd.jpg', 'Nữ', 'Baboga', 1, 'Tôi không chỉ là người đam mê nghệ thuật chụp ảnh, mà còn là người thực hiện những câu chuyện sống động qua ống kính máy ảnh.', 'baac', 'ydfka', 'acadafad', 'Bà Rịa Vũng Tàu', 'https://images.pexels.com/photos/931018/pexels-photo-931018.jpeg?auto=compress&cs=tinysrgb&w=600', 11, 31, 18, 18, 'USER');
...
INSERT INTO `user` VALUES (99, 'kkkkkaasd', 'khoadang88vn2k2@gmail.com', '$2a$10$P.oJs6DJgkDn8detWwsNcePl8IWIAXV.AjhGvOa74jqScaZw21y6i', 'pddkhoa2k2', '0349441302', '2023-12-14 09:02:54.074000', NULL, NULL, 'Male', 'adasdasdasdasda', 1, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 'USER');
...
INSERT INTO `user_category` VALUES (212, 1, 69);
...
INSERT INTO `user_images` VALUES (51, 96, '2023-11-15 11:32:36', 'http://res.cloudinary.com/dmpru0wgq/image/upload/v1702473079/whxvakc6pywfzykkvbxd.jpg');
