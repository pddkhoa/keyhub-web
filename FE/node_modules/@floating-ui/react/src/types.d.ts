...
export { UseTransitionStatusProps, UseTransitionStylesProps, } from './hooks/useTransition';
...
export type OpenChangeReason = 'outside-press' | 'escape-key' | 'ancestor-scroll' | 'reference-press' | 'click' | 'hover' | 'focus' | 'list-navigation' | 'safe-polygon';
