...
var it = ((s) => (s.VERBOSE = "VERBOSE", s.INFO = "INFO", s.WARN = "WARN", s.ERROR = "ERROR", s))(it || {});
var B = {
  BACKSPACE: 8,
  TAB: 9,
  ENTER: 13,
...
var q = ((s) => (s.APPEND_CALLBACK = "appendCallback", s.RENDERED = "rendered", s.MOVED = "moved", s.UPDATED = "updated", s.REMOVED = "removed", s.ON_PASTE = "onPaste", s))(q || {});
var F = class _F extends we {
   ...
   */
  compose() {
    const e = d.make("div", _F.CSS.wrapper), t = d.make("div", _F.CSS.content), o = this.toolInstance.render();
...
var Y = class _Y extends C {
  ...
  addTool(e, t) {
    var r;
    const o = d.make("div", [_Y.CSS.conversionTool]), i = d.make("div", [_Y.CSS.conversionToolIcon]);
    ...
    if (n) {
      const a = d.make("span", _Y.CSS.conversionToolSecondaryLabel, {
        innerText: Re(n)
      });
      d.append(o, a);
    }
  ...
  async filterTools() {
    ...
    this.tools.forEach((i) => {
      ...
      i.button.hidden = n, i.button.classList.toggle(_Y.CSS.conversionToolHidden, n);
    });
  }
  /**
...
var me = ((s) => (s.Opened = "toolbox-opened", s.Closed = "toolbox-closed", s.BlockAdded = "toolbox-block-added", s))(me || {});
...
var ye = ((s) => (s[s.Block = 0] = "Block", s[s.Inline = 1] = "Inline", s[s.Tune = 2] = "Tune", s))(ye || {});
var ke = ((s) => (s.Shortcut = "shortcut", s.Toolbox = "toolbox", s.EnabledInlineTools = "inlineToolbar", s.EnabledBlockTunes = "tunes", s.Config = "config", s))(ke || {});
var vt = ((s) => (s.Shortcut = "shortcut", s.SanitizeConfig = "sanitize", s))(vt || {});
...
var Ue = ((s) => (s.IsInline = "isInline", s.Title = "title", s))(Ue || {});
var xt = ((s) => (s.IsTune = "isTune", s))(xt || {});
var $e = class {
  /**
   * @class
...
var fe = class _fe extends C {
   ...
   */
  genHTML() {
    const { UI: e } = this.Editor, t = e.nodes.holder.querySelector("." + e.CSS.editorWrapper), o = d.make("div", _fe.CSS.overlay, {}), i = d.make("div", _fe.CSS.overlayContainer, {}), n = d.make("div", _fe.CSS.rect, {});
  ...
  async render(e) {
    return new Promise((t) => {
      const { Tools: o, BlockManager: i } = this.Editor, n = e.map(({ type: r, data: a, tunes: l, id: c }) => {
        o.available.has(r) === false && (K(`Tool «${r}» is not found. Check 'tools' property at the Editor.js config.`, "warn"), a = this.composeStubDataForTool(r, a, c), r = o.stubTool);
        let u;
        try {
          u = i.composeBlock({
            id: c,
