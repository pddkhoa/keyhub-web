...
var Wt = function(t3) {
  ...
  function o() {
    ...
    return ye(we(t4 = n.call.apply(n, [this].concat(s3))), "MONTH_REFS", Se(Array(12)).map(function() {
      ...
      var r2 = t4.props, n2 = r2.showFullMonthYearPicker, o2 = r2.renderMonthContent, a4 = r2.locale, s4 = Xe(e3, a4), i3 = Je(e3, a4);
      return o2 ? o2(e3, s4, i3) : n2 ? i3 : s4;
  ...
  function o(t4) {
    ...
    return he(this, o), ye(we(a3 = n.call(this, t4)), "handleClickOutside", function(e3) {
      ...
      if (a3.props.showYearDropdown && !t5)
        return import_react2.default.createElement(_t, { adjustDateOnChange: a3.props.adjustDateOnChange, date: a3.state.date, onSelect: a3.props.onSelect, setOpen: a3.props.setOpen, dropdownMode: a3.props.dropdownMode, onChange: a3.changeYear, minDate: a3.props.minDate, maxDate: a3.props.maxDate, year: getYear(a3.state.date), scrollableYearDropdown: a3.props.scrollableYearDropdown, yearDropdownItemNumber: a3.props.yearDropdownItemNumber });
    }), ye(we(a3), "renderMonthDropdown", function() {
      var t5 = arguments.length > 0 && void 0 !== arguments[0] && arguments[0];
      if (a3.props.showMonthDropdown && !t5)
        return import_react2.default.createElement(Pt, { dropdownMode: a3.props.dropdownMode, locale: a3.props.locale, onChange: a3.changeMonth, month: getMonth(a3.state.date), useShortMonthInDropdown: a3.props.useShortMonthInDropdown });
    }), ye(we(a3), "renderMonthYearDropdown", function() {
      var t5 = arguments.length > 0 && void 0 !== arguments[0] && arguments[0];
      if (a3.props.showMonthYearDropdown && !t5)
        return import_react2.default.createElement(xt, { dropdownMode: a3.props.dropdownMode, locale: a3.props.locale, dateFormat: a3.props.dateFormat, onChange: a3.changeMonthYear, minDate: a3.props.minDate, maxDate: a3.props.maxDate, date: a3.state.date, scrollableMonthYearDropdown: a3.props.scrollableMonthYearDropdown });
      ...
      if (a3.props.showTimeInput)
        return import_react2.default.createElement(Qt, { date: t5, timeString: r2, timeInputLabel: a3.props.timeInputLabel, onChange: a3.props.onTimeChange, customTimeInput: a3.props.customTimeInput });
...
var qt = function(t3) {
  var r2 = t3.icon, n = t3.className, o = void 0 === n ? "" : n, a3 = "react-datepicker__calendar-icon";
  return import_react2.default.isValidElement(r2) ? import_react2.default.cloneElement(r2, { className: "".concat(r2.props.className || "", " ").concat(a3, " ").concat(o) }) : "string" == typeof r2 ? import_react2.default.createElement("i", { className: "".concat(a3, " ").concat(r2, " ").concat(o), "aria-hidden": "true" }) : import_react2.default.createElement("svg", { className: "".concat(a3, " ").concat(o), xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 448 512" }, import_react2.default.createElement("path", { d: "M96 32V64H48C21.5 64 0 85.5 0 112v48H448V112c0-26.5-21.5-48-48-48H352V32c0-17.7-14.3-32-32-32s-32 14.3-32 32V64H160V32c0-17.7-14.3-32-32-32S96 14.3 96 32zM448 192H0V464c0 26.5 21.5 48 48 48H400c26.5 0 48-21.5 48-48V192z" }));
};
var Ut = function(t3) {
  De(n, import_react2.default.Component);
  var r2 = be(n);
...
var er = function(t3) {
  ...
  function s3(t4) {
    ...
    return he(this, s3), ye(we(i2 = a3.call(this, t4)), "getPreSelection", function() {
      ...
      if (e3) {
        ...
        var o = startOfDay(e3);
        if (t5 && r2)
          n = qe(e3, i2.props.minDate, i2.props.maxDate);
        else if (t5) {
  ...
  return fe(s3, [{ key: "componentDidMount", value: function() {
    ...
    var t4 = this.props, r2 = t4.showIcon, n = t4.icon, o = t4.calendarIconClassname;
    return import_react2.default.createElement("div", { className: "react-datepicker__input-container".concat(r2 ? " react-datepicker__view-calendar-icon" : "") }, r2 && import_react2.default.createElement(qt, { icon: n, className: o }), this.state.isRenderAriaLiveMessage && this.renderAriaLiveRegion(), this.renderDateInput(), this.renderClearButton());
  } }, { key: "render", value: function() {
