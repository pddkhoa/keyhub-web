    ...
    !function(e, t) {
      ...
      return function(e) {
          ...
          for (var n2 = 0; n2 < e2.length; n2++) {
            ...
            if (o2) {
              ...
              for (; a2 < r2.parts.length; a2++)
                o2.parts.push(y(r2.parts[a2], t2));
            } else {
              var s2 = [];
              for (a2 = 0; a2 < r2.parts.length; a2++)
                s2.push(y(r2.parts[a2], t2));
        ...
        function b(e2) {
          ...
          return void 0 === e2.attrs.type && (e2.attrs.type = "text/css"), m(t2, e2.attrs), v(e2, t2), t2;
        }
        function m(e2, t2) {
        ...
        function y(e2, t2) {
          ...
          if (t2.singleton) {
            var a2 = c++;
            n2 = u || (u = b(t2)), r2 = L.bind(null, n2, a2, false), o2 = L.bind(null, n2, a2, true);
          } else
            e2.sourceMap && "function" == typeof URL && "function" == typeof URL.createObjectURL && "function" == typeof URL.revokeObjectURL && "function" == typeof Blob && "function" == typeof btoa ? (n2 = function(e3) {
              ...
              return void 0 === e3.attrs.type && (e3.attrs.type = "text/css"), e3.attrs.rel = "stylesheet", m(t3, e3.attrs), v(e3, t3), t3;
            }(t2), r2 = x.bind(null, n2, t2), o2 = function() {
              g(n2), n2.href && URL.revokeObjectURL(n2.href);
            }) : (n2 = b(t2), r2 = M.bind(null, n2), o2 = function() {
              g(n2);
            });
        ...
        var w, k = (w = [], function(e2, t2) {
          return w[e2] = t2, w.filter(Boolean).join("\n");
        });
        function L(e2, t2, n2, r2) {
          var o2 = n2 ? "" : r2.css;
          if (e2.styleSheet)
            e2.styleSheet.cssText = k(t2, o2);
          else {
        ...
        var i = function() {
          function e2(t3) {
            var n3 = t3.data, r2 = t3.config, o2 = t3.api, i3 = t3.readOnly;
            !function(e3, t4) {
              if (!(e3 instanceof t4))
                throw new TypeError("Cannot call a class as a function");
            }(this, e2), this.api = o2, this.readOnly = i3, this._CSS = { block: this.api.styles.block, wrapper: "ce-header" }, this._settings = r2, this._data = this.normalizeData(n3), this._element = this.getTag();
          }
          var t2, n2, i2;
          return t2 = e2, i2 = [{ key: "conversionConfig", get: function() {
          ...
          } }], (n2 = [{ key: "normalizeData", value: function(e3) {
            var t3 = {};
            ...
            var e3 = this;
            return this.levels.map(function(t3) {
              return { icon: t3.svg, label: e3.api.i18n.t("Heading ".concat(t3.number)), onActivate: function() {
                return e3.setLevel(t3.number);
              }, closeOnActivate: true, isActive: e3.currentLevel.number === t3.number };
            });
          } }, { key: "setLevel", value: function(e3) {
            this.data = { level: e3, text: this.data.text };
            ...
            var t3 = e3.detail.data, n3 = this.defaultLevel.number;
            switch (t3.tagName) {
              case "H1":
                n3 = 1;
                break;
            ...
            this._settings.levels && (n3 = this._settings.levels.reduce(function(e4, t4) {
              return Math.abs(t4 - n3) < Math.abs(e4 - n3) ? t4 : e4;
            })), this.data = { level: n3, text: t3.innerHTML };
          ...
          } }]) && o(t2.prototype, n2), i2 && o(t2, i2), e2;
        }();
      }]).default;
    });
  }
...
@editorjs/header/dist/bundle.js:
   ...
   *)
*/
//# sourceMappingURL=@editorjs_header.js.map
