...
} from "./chunk-GMGFP5PB.js";
import "./chunk-XBBVCJBN.js";
import {
  $010c2913dbd2fe3d$export$5cae361ad82dce8b
} from "./chunk-5GD7IGGN.js";
import "./chunk-JGLVZTPM.js";
import {
...
} from "./chunk-M4CS5RL7.js";
import {
  $8927f6f2acc4f386$export$250ffa63cdc0d034
} from "./chunk-BSU6FJ2O.js";
import {
  require_react_dom
} from "./chunk-CSC2LDEO.js";
import {
  $5e63c961fc1ce211$export$8c6ed5c666ac1360,
  $6ed0406888f73fc4$export$c7b2cbe3552a0d05
} from "./chunk-JCNAWXMQ.js";
import {
  _extends
...
var $cc7e05a45900e73f$export$ef9b1a59e592288f = (props) => {
  ...
  const [valueNode, setValueNode] = (0, import_react2.useState)(null);
  const [valueNodeHasChildren, setValueNodeHasChildren] = (0, import_react2.useState)(false);
  ...
  const triggerPointerDownPosRef = (0, import_react2.useRef)(null);
  const isFormControl = trigger ? Boolean(trigger.closest("form")) : true;
  const [nativeOptionsSet, setNativeOptionsSet] = (0, import_react2.useState)(/* @__PURE__ */ new Set());
  const nativeSelectKey = Array.from(nativeOptionsSet).map(
    (option) => option.props.value
  ).join(";");
  return (0, import_react2.createElement)($cf1ac5d9fe0e8206$export$be92b6f5f03c0fe9, popperScope, (0, import_react2.createElement)($cc7e05a45900e73f$var$SelectProvider, {
    required,
    scope: __scopeSelect,
    trigger,
    ...
    disabled
  }, (0, import_react2.createElement)($cc7e05a45900e73f$var$Collection.Provider, {
    scope: __scopeSelect
  }, (0, import_react2.createElement)($cc7e05a45900e73f$var$SelectNativeOptionsProvider, {
    scope: props.__scopeSelect,
    onNativeOptionAdd: (0, import_react2.useCallback)((option) => {
      setNativeOptionsSet(
        (prev) => new Set(prev).add(option)
      );
    }, []),
    onNativeOptionRemove: (0, import_react2.useCallback)((option) => {
  ...
  }, children)), isFormControl ? (0, import_react2.createElement)($cc7e05a45900e73f$var$BubbleSelect, {
    key: nativeSelectKey,
    "aria-hidden": true,
    required,
    tabIndex: -1,
    ...
    disabled
  }, value === void 0 ? (0, import_react2.createElement)("option", {
    value: ""
...
var $cc7e05a45900e73f$export$3ac1e88a1c0b9f1 = (0, import_react2.forwardRef)((props, forwardedRef) => {
...
var $cc7e05a45900e73f$export$e288731fd71264f0 = (0, import_react2.forwardRef)((props, forwardedRef) => {
  ...
  return (0, import_react2.createElement)($8927f6f2acc4f386$export$250ffa63cdc0d034.span, _extends({}, valueProps, {
    ref: composedRefs,
    style: {
      pointerEvents: "none"
    }
...
var $cc7e05a45900e73f$export$99b400cabb58c515 = (0, import_react2.forwardRef)((props, forwardedRef) => {
  const { __scopeSelect, children, ...iconProps } = props;
  return (0, import_react2.createElement)($8927f6f2acc4f386$export$250ffa63cdc0d034.span, _extends({
    "aria-hidden": true
  }, iconProps, {
    ref: forwardedRef
  }), children || "▼");
...
var $cc7e05a45900e73f$export$b2af6c9944296213 = (props) => {
  return (0, import_react2.createElement)($f1701beae083dbae$export$602eac185826482c, _extends({
    asChild: true
  }, props));
};
...
var $cc7e05a45900e73f$export$c973a4b3cb86a03d = (0, import_react2.forwardRef)((props, forwardedRef) => {
  const context = $cc7e05a45900e73f$var$useSelectContext($cc7e05a45900e73f$var$CONTENT_NAME, props.__scopeSelect);
  const [fragment, setFragment] = (0, import_react2.useState)();
  $9f79659886946c16$export$e5c5a5f917a5871c(() => {
    setFragment(new DocumentFragment());
  }, []);
  if (!context.open) {
    const frag = fragment;
    return frag ? (0, import_react_dom.createPortal)((0, import_react2.createElement)($cc7e05a45900e73f$var$SelectContentProvider, {
      scope: props.__scopeSelect
    }, (0, import_react2.createElement)($cc7e05a45900e73f$var$Collection.Slot, {
      scope: props.__scopeSelect
    }, (0, import_react2.createElement)("div", null, props.children))), frag) : null;
  }
  return (0, import_react2.createElement)($cc7e05a45900e73f$var$SelectContentImpl, _extends({}, props, {
    ref: forwardedRef
  }));
});
...
var $cc7e05a45900e73f$var$SelectContentImpl = (0, import_react2.forwardRef)((props, forwardedRef) => {
  const {
    __scopeSelect,
  ...
  const [selectedItemText, setSelectedItemText] = (0, import_react2.useState)(null);
  const getItems = $cc7e05a45900e73f$var$useCollection(__scopeSelect);
  const [isPositioned, setIsPositioned] = (0, import_react2.useState)(false);
  const firstValidItemFoundRef = (0, import_react2.useRef)(false);
  ...
  $3db38b7d1fb3fe6a$export$b7ece24a22aeda8c();
  const focusFirst = (0, import_react2.useCallback)((candidates) => {
  ...
  const focusSelectedItem = (0, import_react2.useCallback)(
    () => focusFirst([
      selectedItem,
      content
    ]),
  ...
  const itemRefCallback = (0, import_react2.useCallback)((node, value, disabled) => {
  ...
  const handleItemLeave = (0, import_react2.useCallback)(
    () => content === null || content === void 0 ? void 0 : content.focus(),
    [
      content
    ]
  );
  const itemTextRefCallback = (0, import_react2.useCallback)((node, value, disabled) => {
    const isFirstValidItem = !firstValidItemFoundRef.current && !disabled;
    const isSelectedItem = context.value !== void 0 && context.value === value;
    if (isSelectedItem || isFirstValidItem)
  ...
  return (0, import_react2.createElement)($cc7e05a45900e73f$var$SelectContentProvider, {
    scope: __scopeSelect,
    content,
    viewport,
    ...
    isPositioned,
    searchRef
  }, (0, import_react2.createElement)(Combination_default, {
    as: $5e63c961fc1ce211$export$8c6ed5c666ac1360,
    allowPinchZoom: true
  }, (0, import_react2.createElement)($d3863c46a17e8a28$export$20e40289641fbbb6, {
    asChild: true,
  ...
  }, (0, import_react2.createElement)(SelectPosition, _extends({
    role: "listbox",
...
var $cc7e05a45900e73f$var$SelectItemAlignedPosition = (0, import_react2.forwardRef)((props, forwardedRef) => {
  const { __scopeSelect, onPlaced, ...popperProps } = props;
  const context = $cc7e05a45900e73f$var$useSelectContext($cc7e05a45900e73f$var$CONTENT_NAME, __scopeSelect);
  const contentContext = $cc7e05a45900e73f$var$useSelectContentContext($cc7e05a45900e73f$var$CONTENT_NAME, __scopeSelect);
  const [contentWrapper, setContentWrapper] = (0, import_react2.useState)(null);
  const [content, setContent] = (0, import_react2.useState)(null);
  const composedRefs = $6ed0406888f73fc4$export$c7b2cbe3552a0d05(
    forwardedRef,
    (node) => setContent(node)
  ...
  const getItems = $cc7e05a45900e73f$var$useCollection(__scopeSelect);
  const shouldExpandOnScrollRef = (0, import_react2.useRef)(false);
  const shouldRepositionRef = (0, import_react2.useRef)(true);
  const { viewport, selectedItem, selectedItemText, focusSelectedItem } = contentContext;
  const position = (0, import_react2.useCallback)(() => {
  ...
  const [contentZIndex, setContentZIndex] = (0, import_react2.useState)();
  $9f79659886946c16$export$e5c5a5f917a5871c(() => {
    if (content)
  ...
  const handleScrollButtonChange = (0, import_react2.useCallback)((node) => {
  ...
  return (0, import_react2.createElement)($cc7e05a45900e73f$var$SelectViewportProvider, {
    scope: __scopeSelect,
    contentWrapper,
  ...
  }, (0, import_react2.createElement)($8927f6f2acc4f386$export$250ffa63cdc0d034.div, _extends({}, popperProps, {
    ref: composedRefs,
    style: {
...
var $cc7e05a45900e73f$var$SelectPopperPosition = (0, import_react2.forwardRef)((props, forwardedRef) => {
  const { __scopeSelect, align = "start", collisionPadding = $cc7e05a45900e73f$var$CONTENT_MARGIN, ...popperProps } = props;
  const popperScope = $cc7e05a45900e73f$var$usePopperScope(__scopeSelect);
  return (0, import_react2.createElement)($cf1ac5d9fe0e8206$export$7c6e2c02157bb7d2, _extends({}, popperScope, popperProps, {
    ref: forwardedRef,
    align,
    collisionPadding,
    style: {
...
var $cc7e05a45900e73f$export$9ed6e7b40248d36d = (0, import_react2.forwardRef)((props, forwardedRef) => {
  ...
  const prevScrollTopRef = (0, import_react2.useRef)(0);
  return (0, import_react2.createElement)(import_react2.Fragment, null, (0, import_react2.createElement)("style", {
...
var $cc7e05a45900e73f$export$ee25a334c55de1f4 = (0, import_react2.forwardRef)((props, forwardedRef) => {
  const { __scopeSelect, ...groupProps } = props;
  const groupId = $1746a345f3d73bb7$export$f680877a34711e37();
  return (0, import_react2.createElement)($cc7e05a45900e73f$var$SelectGroupContextProvider, {
    scope: __scopeSelect,
    id: groupId
  }, (0, import_react2.createElement)($8927f6f2acc4f386$export$250ffa63cdc0d034.div, _extends({
    role: "group",
...
var $cc7e05a45900e73f$export$f67338d29bd972f8 = (0, import_react2.forwardRef)((props, forwardedRef) => {
...
var $cc7e05a45900e73f$export$13ef48a934230896 = (0, import_react2.forwardRef)((props, forwardedRef) => {
  const { __scopeSelect, value, disabled = false, textValue: textValueProp, ...itemProps } = props;
  const context = $cc7e05a45900e73f$var$useSelectContext($cc7e05a45900e73f$var$ITEM_NAME, __scopeSelect);
  const contentContext = $cc7e05a45900e73f$var$useSelectContentContext($cc7e05a45900e73f$var$ITEM_NAME, __scopeSelect);
  const isSelected = context.value === value;
  const [textValue, setTextValue] = (0, import_react2.useState)(textValueProp !== null && textValueProp !== void 0 ? textValueProp : "");
  ...
  return (0, import_react2.createElement)($cc7e05a45900e73f$var$SelectItemContextProvider, {
    scope: __scopeSelect,
    value,
    disabled,
    textId,
    isSelected,
    onItemTextChange: (0, import_react2.useCallback)((node) => {
      setTextValue((prevTextValue) => {
        var _node$textContent;
        return prevTextValue || ((_node$textContent = node === null || node === void 0 ? void 0 : node.textContent) !== null && _node$textContent !== void 0 ? _node$textContent : "").trim();
      });
    }, [])
  }, (0, import_react2.createElement)($cc7e05a45900e73f$var$Collection.ItemSlot, {
    scope: __scopeSelect,
    value,
    disabled,
    textValue
...
var $cc7e05a45900e73f$export$3572fb0fb821ff49 = (0, import_react2.forwardRef)((props, forwardedRef) => {
  const { __scopeSelect, className, style, ...itemTextProps } = props;
  const context = $cc7e05a45900e73f$var$useSelectContext($cc7e05a45900e73f$var$ITEM_TEXT_NAME, __scopeSelect);
  const contentContext = $cc7e05a45900e73f$var$useSelectContentContext($cc7e05a45900e73f$var$ITEM_TEXT_NAME, __scopeSelect);
  const itemContext = $cc7e05a45900e73f$var$useSelectItemContext($cc7e05a45900e73f$var$ITEM_TEXT_NAME, __scopeSelect);
  const nativeOptionsContext = $cc7e05a45900e73f$var$useSelectNativeOptionsContext($cc7e05a45900e73f$var$ITEM_TEXT_NAME, __scopeSelect);
  const [itemTextNode, setItemTextNode] = (0, import_react2.useState)(null);
  const composedRefs = $6ed0406888f73fc4$export$c7b2cbe3552a0d05(
    forwardedRef,
  ...
  const nativeOption = (0, import_react2.useMemo)(
    () => (0, import_react2.createElement)("option", {
  ...
  return (0, import_react2.createElement)(import_react2.Fragment, null, (0, import_react2.createElement)($8927f6f2acc4f386$export$250ffa63cdc0d034.span, _extends({
...
var $cc7e05a45900e73f$export$6b9198de19accfe6 = (0, import_react2.forwardRef)((props, forwardedRef) => {
  const { __scopeSelect, ...itemIndicatorProps } = props;
  const itemContext = $cc7e05a45900e73f$var$useSelectItemContext($cc7e05a45900e73f$var$ITEM_INDICATOR_NAME, __scopeSelect);
  return itemContext.isSelected ? (0, import_react2.createElement)($8927f6f2acc4f386$export$250ffa63cdc0d034.span, _extends({
    "aria-hidden": true
  }, itemIndicatorProps, {
    ref: forwardedRef
  })) : null;
...
var $cc7e05a45900e73f$export$d8117927658af6d7 = (0, import_react2.forwardRef)((props, forwardedRef) => {
  const contentContext = $cc7e05a45900e73f$var$useSelectContentContext($cc7e05a45900e73f$var$SCROLL_UP_BUTTON_NAME, props.__scopeSelect);
  const viewportContext = $cc7e05a45900e73f$var$useSelectViewportContext($cc7e05a45900e73f$var$SCROLL_UP_BUTTON_NAME, props.__scopeSelect);
  const [canScrollUp1, setCanScrollUp] = (0, import_react2.useState)(false);
  ...
  return canScrollUp1 ? (0, import_react2.createElement)($cc7e05a45900e73f$var$SelectScrollButtonImpl, _extends({}, props, {
    ref: composedRefs,
    onAutoScroll: () => {
...
var $cc7e05a45900e73f$export$ff951e476c12189 = (0, import_react2.forwardRef)((props, forwardedRef) => {
  const contentContext = $cc7e05a45900e73f$var$useSelectContentContext($cc7e05a45900e73f$var$SCROLL_DOWN_BUTTON_NAME, props.__scopeSelect);
  const viewportContext = $cc7e05a45900e73f$var$useSelectViewportContext($cc7e05a45900e73f$var$SCROLL_DOWN_BUTTON_NAME, props.__scopeSelect);
  const [canScrollDown1, setCanScrollDown] = (0, import_react2.useState)(false);
  const composedRefs = $6ed0406888f73fc4$export$c7b2cbe3552a0d05(forwardedRef, viewportContext.onScrollButtonChange);
  $9f79659886946c16$export$e5c5a5f917a5871c(() => {
    if (contentContext.viewport && contentContext.isPositioned) {
      let handleScroll = function() {
  ...
  return canScrollDown1 ? (0, import_react2.createElement)($cc7e05a45900e73f$var$SelectScrollButtonImpl, _extends({}, props, {
    ref: composedRefs,
    onAutoScroll: () => {
      const { viewport, selectedItem } = contentContext;
      if (viewport && selectedItem)
...
var $cc7e05a45900e73f$var$SelectScrollButtonImpl = (0, import_react2.forwardRef)((props, forwardedRef) => {
  const { __scopeSelect, onAutoScroll, ...scrollIndicatorProps } = props;
  const contentContext = $cc7e05a45900e73f$var$useSelectContentContext("SelectScrollButton", __scopeSelect);
  const autoScrollTimerRef = (0, import_react2.useRef)(null);
  const getItems = $cc7e05a45900e73f$var$useCollection(__scopeSelect);
  const clearAutoScrollTimer = (0, import_react2.useCallback)(() => {
...
var $cc7e05a45900e73f$export$eba4b1df07cb1d3 = (0, import_react2.forwardRef)((props, forwardedRef) => {
...
var $cc7e05a45900e73f$export$314f4cb8f8099628 = (0, import_react2.forwardRef)((props, forwardedRef) => {
  ...
  return context.open && contentContext.position === "popper" ? (0, import_react2.createElement)($cf1ac5d9fe0e8206$export$21b07c8f274aebd5, _extends({}, popperScope, arrowProps, {
    ref: forwardedRef
  })) : null;
});
...
var $cc7e05a45900e73f$var$BubbleSelect = (0, import_react2.forwardRef)((props, forwardedRef) => {
  ...
  return (0, import_react2.createElement)($ea1ef594cf570d83$export$439d29a4e110a164, {
    asChild: true
  }, (0, import_react2.createElement)("select", _extends({}, selectProps, {
    ref: composedRefs,
    defaultValue: value
  })));
});
...
function $cc7e05a45900e73f$var$useTypeaheadSearch(onSearchChange) {
  ...
  const handleTypeaheadSearch = (0, import_react2.useCallback)((key) => {
  ...
  const resetTypeahead = (0, import_react2.useCallback)(() => {
    searchRef.current = "";
    window.clearTimeout(timerRef.current);
  }, []);
  (0, import_react2.useEffect)(() => {
