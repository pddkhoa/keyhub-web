...
var require_bundle = __commonJS({
  "node_modules/@editorjs/paragraph/dist/bundle.js"(exports, module) {
    !function(e, t) {
      "object" == typeof exports && "object" == typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define([], t) : "object" == typeof exports ? exports.Paragraph = t() : e.Paragraph = t();
    }(window, function() {
      return function(e) {
        var t = {};
        function n(r) {
        ...
        function u(e2, t2) {
          for (var n2 = {}, r2 = [], o2 = 0; o2 < e2.length; o2++) {
            var a2 = e2[o2], u2 = t2.base ? a2[0] + t2.base : a2[0], l2 = n2[u2] || 0, s2 = "".concat(u2, " ").concat(l2);
            n2[u2] = l2 + 1;
            var f2 = c(s2), d2 = { css: a2[1], media: a2[2], sourceMap: a2[3] };
            -1 !== f2 ? (i[f2].references++, i[f2].updater(d2)) : i.push({ identifier: s2, updater: y(d2, t2), references: 1 }), r2.push(s2);
          }
          return r2;
        }
        function l(e2) {
        ...
        function y(e2, t2) {
          ...
          if (t2.singleton) {
            var a2 = v++;
            n2 = h || (h = l(t2)), r2 = d.bind(null, n2, a2, false), o2 = d.bind(null, n2, a2, true);
          } else
            n2 = l(t2), r2 = p.bind(null, n2, t2), o2 = function() {
              !function(e3) {
        ...
        e.exports = function(e2, t2) {
          ...
          return function(e3) {
            if (e3 = e3 || [], "[object Array]" === Object.prototype.toString.call(e3)) {
              ...
              for (var a2 = u(e3, t2), l2 = 0; l2 < n2.length; l2++) {
                var s2 = c(n2[l2]);
        ...
        var a = function() {
          function e2(t2) {
            ...
            }(this, e2), this.api = o2, this.readOnly = a2, this._CSS = { block: this.api.styles.block, wrapper: "ce-paragraph" }, this.readOnly || (this.onKeyUp = this.onKeyUp.bind(this)), this._placeholder = r2.placeholder ? r2.placeholder : e2.DEFAULT_PLACEHOLDER, this._data = {}, this._element = null, this._preserveBlank = void 0 !== r2.preserveBlank && r2.preserveBlank, this.data = n2;
          }
          return o(e2, null, [{ key: "DEFAULT_PLACEHOLDER", get: function() {
            return "";
          } }]), o(e2, [{ key: "onKeyUp", value: function(e3) {
            "Backspace" !== e3.code && "Delete" !== e3.code || "" === this._element.textContent && (this._element.innerHTML = "");
            ...
            return null === this._element && (this._element = this.drawView()), this.hydrate(), this._element;
            ...
            window.requestAnimationFrame(function() {
              e3._element.innerHTML = e3._data.text || "";
            });
            ...
            this._data = e3 || {}, null !== this._element && this.hydrate();
...
@editorjs/paragraph/dist/bundle.js:
  (**
   ...
   *)
*/
//# sourceMappingURL=@editorjs_paragraph.js.map
