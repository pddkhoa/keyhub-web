...
const adminSlice = createSlice({
    ...
    initialState: {
        ...
        listCommentReport: [] as ReportComment[],
    ...
    reducers: {
        ...
        getListCommentReportSuccess: (state, action) => {
            state.listCommentReport = action.payload;
        },
        ...
        evaluteCommentReportSuccess: (state, action) => {
            const { report_id } = action.payload;

            state.listCommentReport = state.listCommentReport.filter(
                (comment) => comment.id !== report_id
            );
        },
    },
});
