...
export const ModalUser: React.FC<ModalUserProps> = ({ setFlag, data }) => {
                    ...
                    <div className="flex flex-wrap justify-center">
                        <div className="w-full px-4">
                            ...
                            <p className="text-md text-title-foreground text-center px-5">
                                ...
                                recusandae, debitis eum voluptatem ad,
        ...
        setDataUser((prev) =>
            prev.map((user) => {
                if (user.id === id) {
                    return {
                        ...user,
                        checkStatusFollow: !user.checkStatusFollow,
                    };
                }
                return user;
            })
