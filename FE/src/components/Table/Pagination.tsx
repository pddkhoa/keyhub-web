...
const classes = {
  base: {
    item: "[&>.rc-pagination-item>a]:text-gray-200 [&>.rc-pagination-item>a]:font-medium [&>li.rc-pagination-item]:border-gray-100 [&>.rc-pagination-item>a]:hover:brightness-150 [&>.rc-pagination-item>a]:focus:text-blue-200 [&>.rc-pagination-item:not(.rc-pagination-item-active)]:bg-gray-700",
...
export default function TablePagination({
  ...
  return (
    ...
    >
      {!setPageSize ? (
        total && (
          <div className="hidden text-gray-200 sm:inline-flex">
            {props.current} of {Math.ceil(total / pageSize)} pages
          </div>
        )
      ) : (
        <div className="hidden items-center sm:flex text-gray-200">
          Rows per page:{" "}
          {/* <Select
      ...
      <Pagination
        ...
        defaultCurrent={1}
        showLessItems={true}
        prevIconClassName="py-0 text-gray-200 !leading-[26px]"
        nextIconClassName="py-0 text-gray-200 !leading-[26px]"
        {...props}
      />
    </div>
  );
