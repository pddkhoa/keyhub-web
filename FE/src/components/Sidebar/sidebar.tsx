      ...
      <div className="space-y-2 text-sm mt-10">
        ...
        <div>
          <div
            ...
            className="flex w-full items-center space-x-3 text-gray-700 hover p-2 group rounded-md font-medium hover:bg-gray-200 dark:text-white dark:hover:bg-gray-500 cursor-pointer focus:shadow-outline"
          >
            <span className="text-gray-600 pl-2">
              <BiLogOut className="w-6 h-6  text-black dark:text-white transition hover:duration-300 group-hover:scale-110 ease-in-out" />
            </span>
            <span
              className={`text-lg  dark:text-white ${
                open ? `scale-100 duration-300 transition` : `scale-0`
