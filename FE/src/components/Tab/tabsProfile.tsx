...
import { ModalFilters } from "../Modal/Tool/modalFilters";
        ...
        <div className="w-full bg-card shadow-lg  rounded-lg overflow-hidden">
          <div className="py-2 px-6 flex justify-between items-center">
            ...
            <div className="flex gap-5">
              ...
              <Button>Option View</Button>
            </div>
          </div>
        </div>
        <TabContent tabName={tabs} />
      </div>
...
export const TabContent: React.FC<TabsContentProps> = ({ tabName }) => {
  switch (tabName) {
    case "TAB_BLOG":
      return (
        <div>
