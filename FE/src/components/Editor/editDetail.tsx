      ...
      <div className="grid w-full items-center gap-4 p-2">
        <div className="flex flex-col">
          <div className="relative ">
            <Label htmlFor="title" className="text-md text-title-foreground">
              Title
            </Label>
            <Textarea
              id="title"
        ...
        <div className="flex flex-col space-y-2">
          <div className="relative space-y-2">
            <Label htmlFor="series" className="text-md text-title-foreground">
              Series
            </Label>
        ...
        <div className="flex flex-col space-y-2">
          <Label className="text-title-foreground text-md">Avatar Blog</Label>
