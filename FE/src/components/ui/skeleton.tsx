...
export const SkeletonUser = () => {
    return (
        <div className="flex flex-col  rounded shadow-md w-96  animate-pulse h-96">
            <div className="h-80 rounded-t bg-gray-700"></div>
...
export const SkeletonNoti = () => {
    return (
        <div
            role="status"
            className="max-w-md p-4 space-y-4  rounded shadow animate-pulse "
        >
