export const Skeleton = () => {
  return (
    <div className="flex w-full mx-4 overflow-hidden bg-white rounded-lg shadow-lg animate-pulse dark:bg-gray-800">
...
export const SkeletonPost = () => {
  return (
    <div
      role="status"
      className="w-full p-4 h-[400px]  rounded shadow animate-pulse md:p-6 "
    >
      ...
      <div className="flex items-center justify-center h-48 my-4 bg-gray-300 rounded dark:bg-gray-700">
        <svg
...
export const SkeletonUser = () => {
  return (
    <div className="flex flex-col items-center p-8">
      <p className="w-32 h-32 bg-gray-200 rounded-full dark:bg-gray-700 ring-4 ring-gray-300 dark:ring-gray-600" />
      <h1 className="w-40 h-2 mx-auto mt-6 bg-gray-200 rounded-lg dark:bg-gray-700" />
      <p className="w-32 h-2 mx-auto mt-4 bg-gray-200 rounded-lg dark:bg-gray-700" />
      <p className="w-56 h-2 mx-auto mt-4 bg-gray-200 rounded-lg dark:bg-gray-700" />
    </div>
  );
};
