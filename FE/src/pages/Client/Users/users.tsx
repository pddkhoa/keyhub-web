...
const Users = () => {
    ...
    const getUserAllCustom = async (
        ...
        return await ClientServices.getUserAll(
            indexPage,
            accessToken,
            axiosJWT
        );
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            const { body } = await ClientServices.getUserMost(
                accessToken,
                axiosJWT
            );
        ...
        <div className="container  min-h-0 mx-auto w-10/12 py-20">
            <div className="flex flex-col gap-5">
                        ...
                        <div className="flex relative z-1 flex-col items-center">
                            ...
                            <div className="flex flex-col gap-3 mt-8">
                                ...
                                <span className="text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-gray-400 to-pink-100 ">
                                    Simplify your security with authentication
                                    services
                                </span>
                            </div>
                        </div>
                ...
                <div className="mb-4 flex flex-col h-fit ">
                    <Label className="text-title text-xl font-bold">
                        Suggestions
                    </Label>
                    <div className="">
                        <SlideUser
