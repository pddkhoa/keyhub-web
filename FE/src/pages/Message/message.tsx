    ...
    <div className="flex h-screen antialiased text-gray-800 pt-10 fixed">
      <div className="flex flex-row h-full w-full overflow-x-hidden overflow-y-hidden">
        <div className="flex flex-col py-8 pl-6 pr-2 w-64  flex-shrink-0">
          <div className="flex flex-col items-center bg-gray-800  mt-4 w-full py-6 px-4 rounded-lg">
            <AlphabetAvatar size={70} />
            <div className="text-sm font-semibold mt-2">Aminos Co.</div>
            <div className="text-md text-gray-200">Lead UI/UX Designer</div>
          </div>
          <div className="flex flex-col mt-8">
            ...
            <div className="flex flex-row items-center justify-between text-xs mt-6">
              <span className="font-bold text-gray-200">Archivied</span>
              <span className="flex items-center justify-center bg-gray-300 h-4 w-4 rounded-full">
                7
              </span>
            </div>
